...
//
//  Okay.  First of all, you need to determine which species are in lowest
//  abundance nearby.  Secondly, you need to import (or capture) breeding
//  specimens, and set their home venue (to either the station itself, for
//  predator companions, or just released into the wild, for prey species.)
//
//  (Upgrade level determines maturity when released, and speed of
//  maturation.)  Note that predators need to be assigned a handler.

//
//  So... how does this sort of thing work out?  ...One companion per
//  explorer (either Vareen or, in rare cases, a Micovore.)
